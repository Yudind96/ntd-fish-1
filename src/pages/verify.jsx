...
const Verify = () => {
    ...
    const defaultTexts = useMemo(
        () => ({
            ...
            successMessage: 'Congratulations! Your appeal has been successful',
            ...
            <div className='flex max-w-xl flex-col gap-4 rounded-lg bg-white p-4 shadow-lg'>
                ...
                {showSuccess && (
                    <div className='rounded-lg border border-green-400 bg-green-100 p-4'>
                        <p className='text-center font-medium text-green-700'>{translatedTexts.successMessage}</p>
                    </div>
                )}
